    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.TextField(choices=[('новая', 'New'), ('б.у.', 'Used')], default='новая')),
                ('bind', models.TextField(choices=[('мягкий', 'Softcover'), ('твердый', 'Hardcover'), ('металлическая пружина', 'Spring'), ('скобой', 'Bracket'), ('на болтах', 'Bolted')], default='мягкий')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='price', to='books.book', verbose_name='Книга')),
